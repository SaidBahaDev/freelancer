        ...
        <form action="index.php" method="post">
                ...
                <div class="row top-space">
                  <div class="col-8 offset-2">
                    ...
                    <input type="text" class="form-control" name="specialite" value="<?php echo isset($_POST['specialite']) ? trim($_POST['specialite']) : "" ?>" >
                  </div>
                </div>
                <div class="row top-space">
                  <div class="col-2 offset-8">
                    <input type="hidden" name="action" value='AjouterPrestataire'/>
