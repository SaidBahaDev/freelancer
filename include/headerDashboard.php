...
<body>
    <div class="container-fluid container-full-height">
      <div class="row row-full-height">
          <div class="col-sm-2 px-1 bg-white">
              <div class="py-2 sticky-top ">
                  <div class="nav flex-sm-column">
                      <?php
                      if ($_SESSION["role"]== "entreprise") {
                        echo '<a class="nav-link" href="index.php?action=AddProject">Ajouter un Projet</a>
                        <a class="nav-link" href="index.php?action=MyProjects">Mes Projets</a>';
                      }
                      if ($_SESSION["role"]== "prestataire") {
                        echo '<a class="nav-link" href="index.php?action=MyApplications">Mes Demandes</a>
                        ';
                      }
                      if ($_SESSION["role"]== "admin") {
                        echo '<a class="nav-link">Gestion des Demandes</a>
                        <a class="nav-link ml-3" href="index.php?action=DemandesEnAttente">En attente <span class="notificationCount">'.CountProjectsHasApplications("en attente").'</span></a>
                        <a class="nav-link ml-3" href="index.php?action=DemandesAssigne">Assigné</a>
                        <a class="nav-link">Gestion d\'Utilisateurs</a>
                        <a class="nav-link ml-3" href="index.php?action=UtilisateursEntreprise">Entreprise</a>
                        <a class="nav-link ml-3" href="index.php?action=UtilisateursPrestataire">Prestataire</a>
                        <a class="nav-link">Gestion des Projets</a>
                        <a class="nav-link ml-3" href="index.php?action=Projets">Projets</a>
                        ';
                      }
                      echo '<a class="nav-link" href="index.php?action=Profile">Mon Profile</a>
                          <a class="nav-link" href="index.php?action=Logout">Quitter</a>'   
                      ?>
                  </div>
              </div>
          </div>
